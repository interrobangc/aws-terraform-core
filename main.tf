...
module "mgmt_vpc" {
  source = "github.com/interrobangc/terraform-aws-vpc?ref=v0.1.6"
  env    = "${var.mgmt_env}"
...
module "mgmt_sg" {
  source = "github.com/interrobangc/terraform-aws-security-groups?ref=v0.1"
  env    = "${var.mgmt_env}"
...
module "prod_vpc_peering" {
  source = "github.com/interrobangc/terraform-aws-vpc-peering?ref=v0.1"
