...
module "mgmt_vpc" {
  source = "github.com/interrobangc/terraform-aws-vpc?ref=v0.2.1"
  env    = var.mgmt_env
...
module "prod_vpc_peering" {
  source = "github.com/interrobangc/terraform-aws-vpc-peering?ref=v0.2.1"
...
module "bastion" {
  source = "github.com/interrobangc/terraform-aws-bastion?ref=v0.2.4"
  env    = var.mgmt_env
  ami    = var.bastion_ami
