  ...
  value = "${map(
    "dev", map(
      ...
      "subnets", map(
        ...
        "elasticache", "${module.dev_vpc.elasticache_subnets}",
        "redshift", "${module.dev_vpc.redshift_subnets}",
        "intra", "${module.dev_vpc.intra_subnets}",
    ...
    "prod", map(
      ...
      "subnets", map(
        ...
        "elasticache", "${module.prod_vpc.elasticache_subnets}",
        "redshift", "${module.prod_vpc.redshift_subnets}",
        "intra", "${module.prod_vpc.intra_subnets}",
    ...
    "mgmt", map(
      ...
      "subnets", map(
        ...
        "elasticache", "${module.mgmt_vpc.elasticache_subnets}",
        "redshift", "${module.mgmt_vpc.redshift_subnets}",
        "intra", "${module.mgmt_vpc.intra_subnets}",
